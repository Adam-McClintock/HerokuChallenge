using HerokuChallenge.AutomationResources;
using HerokuChallenge.Pages;
...
namespace HerokuChallenge.Steps
{
    [Binding]
    public class ChallengingDOMSteps : BaseClass
    {
        private ChallengingDOMPage challengingDOMPage;

        public ChallengingDOMSteps(ChallengingDOMPage challengingDOMPage, IWebDriver driver) : base(driver)
        {
            this.challengingDOMPage = new ChallengingDOMPage(Driver);
        }
